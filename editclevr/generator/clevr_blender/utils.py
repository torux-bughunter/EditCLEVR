...
def set_layer(obj, layer_idx):
  """Compatibility shim for old layer-based hiding.

  Blender 2.8+ removed object layers, so callers now use layer 2 as a signal to
  hide objects from render and layer 0 as a signal to show them again.
  """
...
def add_object(object_dir, name, scale, loc, theta=0):
  ...
  bpy.ops.wm.append(directory=directory + os.sep, filename=name)
